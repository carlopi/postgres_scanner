...
#define CONFIGURE_ARGS " '--without-llvm' '--without-icu' '--without-tcl' '--without-perl' '--without-python' '--without-gssapi' '--without-pam' '--without-bsd-auth' '--without-ldap' '--without-bonjour' '--without-selinux' '--without-systemd' '--without-readline' '--without-libxml' '--without-libxslt' '--without-zlib' '--without-lz4' '--without-openssl' 'CC=emcc' 'CXX=emcc'"
...
#define PG_VERSION_STR "PostgreSQL 15.2 on aarch64-apple-darwin22.4.0, compiled by emcc (Emscripten gcc/clang-like replacement + linker emulating GNU ld) 3.1.51 (c0c2ca1314672a25699846b4663701bcb6f69cca), 32-bit"
